...
TRAIN_MODEL_PATH = "model/late_fusion_lr=2.5e-5"
...
EPOCH_COUNT = 25       #     tum veri kumesi uzerinden kac kez gecilecek. baktiniz loss cok dusmemeye basladiysa 40-50 epoch sonra train i durdurabilirsiniz.
