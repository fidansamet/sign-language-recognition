...
TRAIN_MODEL_PATH = "model/temporal_e-5_128"
...
BATCH_SIZE = 128          #   her seferde kac adet resmi isleyecek model. eger train i calistirirken memory hatasi alirsaniz bunu azaltmaniz lazim.
