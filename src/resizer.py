...
cfg.create_dir("../" + cfg.RESIZED_RGB_PATH)

cfg.create_dir("../" + cfg.RESIZED_RGB_PATH + "/train")
SAVE_PATH = "../" + cfg.RESIZED_RGB_PATH + "/train"
...
for vid in train_json:
    ...
    cfg.create_dir(SAVE_PATH + "/" + video_id)
...
cfg.create_dir("../" + cfg.RESIZED_RGB_PATH + "/val")
SAVE_PATH = "../" + cfg.RESIZED_RGB_PATH + "/val"
train_json_path = "../" + cfg.MSASL_RGB_PATH + "/%s_val_rgb.json" % (cfg.DATASET_NAME)
train_path = "../" + cfg.MSASL_RGB_PATH + "/val"
...
cfg.create_dir("../" + cfg.RESIZED_RGB_PATH + "/test")
