...
'''Late Fusion Model'''
class LateFusionDataset(data.Dataset):
...
def get_late_fusion_loader(flow_name_list, flow_label_list, batch_size, shuffle, transform, num_workers):
    dataset = TemporalDataset(flow_name_list=flow_name_list,
                              flow_label_list=flow_label_list,
                              transform=transform)
...
'''Early Fusion Model'''
class EarlyFusionDataset(data.Dataset):
...
def get_early_fusion_loader(flow_name_list, flow_label_list, batch_size, shuffle, transform, num_workers):
    dataset = TemporalDataset(flow_name_list=flow_name_list,
                              flow_label_list=flow_label_list,
                              transform=transform)
